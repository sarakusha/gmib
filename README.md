...
Локальную установку gmib можно расширять плагинами из архивов с расширением `.gmib-plugin`. Для
установки откройте раздел _Плагины_, нажмите _Установить_ и выберите архив. Перед установкой gmib
показывает название, версию и запрошенные разрешения. После установки, обновления, включения или
