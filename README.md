...
- _Планировщик_ - запуск действий плеера по указанной дате и времени или по повторяющемуся
  расписанию в формате cron. Можно загрузить и воспроизвести выбранный плейлист, выполнить Play,
  Stop, Next или запустить ролик из текущего плейлиста по номеру. Задания сохраняются между
  запусками и активируются при запуске GMIB.
