...
общий mDNS-транспорт. Это особенно важно в Windows, где несколько сокетов на UDP-порту 5353 могут
получать разные multicast-пакеты и создавать неполный список компьютеров или несколько главных.
