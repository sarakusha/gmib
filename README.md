...
macOS помечает файлы из интернета (особенно неподписанные приложения с GitHub) как потенциально опасные с помощью атрибута карантина  com.apple.quarantine. Это приводит к блокировке, даже если файл цел и не повреждён. Чтобы снять эту блокировку, нужно удалить атрибут карантина с помощью команды в терминале:
