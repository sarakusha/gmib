...
нет в этой версии. Выбор движка воспроизведения доступен с версии 4.11.0, перемотка с версии 4.12.0,
а планировщики GMIB и плеера, а также шейдеры областей вывода - с версии 5.0.0. При подключении к
более старой версии соответствующие элементы управления не отображаются.
...
При удаленном подключении к GMIB ниже 5.0.0 настройки шейдеров скрываются.
