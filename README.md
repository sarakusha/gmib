...
- _Планировщик_ - запуск действий плеера по указанной дате и времени или по повторяющемуся
  ...
  воспроизведение, выполнить Play, Stop, Next или запустить ролик из текущего плейлиста по номеру.
  Задания сохраняются между запусками и активируются при запуске GMIB. Задание можно запустить
  вручную для проверки действия; будущий запуск одиночного задания при этом сохраняется.
