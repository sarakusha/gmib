interface Window {
    ...
    readonly getLicenseState: () => Promise<import("/Users/sarakusha/src/gmib/packages/common/license").LicenseRuntimeState | undefined>;
    readonly onLicenseStateChange: (listener: (state: import("/Users/sarakusha/src/gmib/packages/common/license").LicenseRuntimeState) => void) => () => void;
